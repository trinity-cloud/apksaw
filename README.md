...
<p align="center">
  ...
  <p align="center">97 MCP tools. Point any MCP coding agent at your APK and ask it to find the bugs.</p>
</p>
...
Restart your agent — all 97 tools appear automatically. Then just talk to it:
...
The 97 tools split into two kinds:
...
📖 **Full inventory:** [Tool Reference](docs/tool-reference.md) (all 97 tools) · **Internals:** [Architecture](docs/architecture.md)
...
See the [Tool Reference](docs/tool-reference.md) for all 97 tools and [Architecture](docs/architecture.md) for the module layout.
